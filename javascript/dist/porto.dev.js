...
var screenSize = document.getElementById('nav');
var navCloseButton = document.getElementById('closebtn');
...
respondToScreenSize(); // window.addEventListener('load', window.addEventListener("resize", respondToScreenSize()))

/* Set the width of the side navigation to 250px */

function openNav() {
  //use 100% to cover the whole page
  document.getElementById("nav").style.width = "250px"; //to use it with the page's main content use this :

  /* Set the width of the side navigation
   to 250px and the left margin of the page content to 250px */

  document.getElementById("main").style.marginLeft = "250px"; //to highlight the main page when the side nav is open use :
...
function closeNav() {
  document.getElementById("nav").style.width = "0"; //to use it with the main page use this :

  /* Set the width of the side navigation to 0 and the left margin
   of the page content to 0 */

  document.getElementById("main").style.marginLeft = "0"; // to remove the background opacity use :
